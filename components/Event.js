  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          navigation.navigate("NewEvent", { event: event, state: "edit" })
        }
      >
      ...
      <View style={styles.details}>
        <TouchableOpacity style={styles.calanderButton}>
          <Image
            source={require("../assets/calander-icon.png")}
        ...
        <View style={styles.midSection}>
          ...
          >
            ...
            <Text style={styles.contentText}>
              {event.attendingMembers.length} Attending
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <Collapsible collapsed={collapsed}>
        <ScrollView style={styles.drawer}>
          {event.songsList.map((songId) => {
            ...
            return (
              <Text key={songId} style={styles.song}>
                {song.name}
              </Text>
            );
          })}
      ...
      <MembersModal
        headLine={"Attending Members"}
        ids={event.attendingMembers}
